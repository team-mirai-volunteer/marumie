  ...
  return (
    <div className="flex items-center self-stretch bg-gradient-to-br from-[#BCECD3] to-[#64D8C6] rounded-[22px] p-8 sm:p-12">
      <div className="flex flex-col justify-center gap-2 sm:gap-[10.84px]">
        ...
        <p className="text-xs sm:text-base font-bold leading-[1.667] sm:leading-[1.75] text-gray-800 font-japanese max-w-[874px]">
          政治資金の徹底的な透明化に向けて、国民の皆さまとともに、少しずつですが着実に歩んでまいります。ロードマップはこちらのnoteをお読みください、
        </p>
      </div>
    </div>
  );
