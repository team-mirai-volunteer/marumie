...
interface PoliticalOrganizationItem {
  id: string;
  label: string;
  checked: boolean;
}
...
export default function PoliticalOrganizationFilter({
  ...
  }, [availableOrganizations, selectedOrganizations]);
  ...
  const handleSelectAll = () => {
    const allChecked = organizations.every((org) => org.checked);
    setOrganizations((prev) =>
  ...
  const handleOk = () => {
    const selectedIds = organizations
            ...
            >
              ...
              >
                <div className="w-[18px] h-[18px] flex items-center justify-center">
                  {organizations.every((org) => org.checked) && (
              ...
              {organizations.map((organization) => (
                ...
                >
                  ...
                  <span
                    className={`text-[13px] leading-[1.54] text-left flex-1 ${
                      organization.checked ? "font-bold" : "font-medium"
                    } text-[#47474C]`}
                  >
                    {organization.label}
                  </span>
